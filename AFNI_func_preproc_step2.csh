...
cd $SUBJECTS_DIR/${subj}/${task}/func
...
#echo "****************************************************************"
#
#cp $SUBJECTS_DIR/${subj}/${task}/anat/*sksp* $activeSubjectdirectory
...
#echo "****************************************************************"
#
#cd $SUBJECTS_DIR/${subj}/${task}/anat/
#
##rm ${activeSubjectdirectory}/anat/${study}.${subj}.anat.seg.fsl.MNI.3x3x3+tlrc*
#
#3dfractionize \
#-template $SUBJECTS_DIR/${subj}/${task}/func/${study}.${subj}.${task}.motion_tlrc_py+tlrc \
...
#-vnorm \
#-sval 2 \
#-mask $SUBJECTS_DIR/${subj}/${task}/anat/${study}.${subj}.anat.seg.fsl.MNI.CSF.erode1+tlrc \
#-polort $polort \
...
#-vnorm \
#-sval 2 \
#-mask $SUBJECTS_DIR/${subj}/${task}/anat/${study}.${subj}.anat.seg.fsl.MNI.WM.erode2+tlrc \
#-polort $polort \
