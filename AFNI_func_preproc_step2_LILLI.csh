...
echo "****************************************************************"
echo " AFNI | 3dResample | Anatomy 1x1x1 --> 3x3x3 (EPI dimensions) "
echo "****************************************************************"

3dresample \
-prefix ${DATA_DIR}/func/${study}.${subj}.anat.3x3x3 \
-input ${DATA_DIR}/anat/${study}.${subj}.anat+orig \
-master ${DATA_DIR}/func/${study}.${subj}.${task}.motion+tlrc
...
align_epi_anat.py \
-anat ${DATA_DIR}/func/${study}.${subj}.anat.3x3x3 \
-epi ${DATA_DIR}/func/${study}.${subj}.${task}.motion+tlrc \
-tlrc_apar ${DATA_DIR}/anat/${study}.${subj}.anat+tlrc \
-epi_base 6 \
-epi2anat \
-anat_has_skull no \
-volreg off \
...
#echo "****************************************************************"
#echo " AFNI | Mask EPI " ***BETA MODE***
#echo "****************************************************************"

#3dmerge \
#-doall \
#-1fmask msit.hc001.anat.mask+tlrc \
#-prefix x msit.hc001.msit_bsm.motion.resid+tlrc

#3dcalc \
#-a x+tlrc \
#-b msit.hc001.anat.mask+tlrc \
#-prefix y \
#-expr 'a*step(b)'
...
#${study}.${subj}.${task}.motion_tlrc.py+tlrc
...
#3dfractionize \
#-template ${DATA_DIR}/func/${study}.${subj}.${task}.motion_tlrc.py+tlrc \
#-input ${study}.${subj}.anat.seg.fsl+tlrc \
#-prefix ${study}.${subj}.anat.seg.fsl.3x3x3 \
#-clip .2 -vote

#3dcalc \
#-overwrite \
#-a ${study}.${subj}.anat.seg.fsl.3x3x3+tlrc \
#-expr 'equals(a,1)' \
...
#-polort $polort \
#./${study}.${subj}.${task}.motion_tlrc.py+tlrc > ./NOISE_REGRESSOR.${task}.CSF.1D
...
#-polort $polort \
#./${study}.${subj}.${task}.motion_tlrc.py+tlrc > ./NOISE_REGRESSOR.${task}.WM.1D
...
#3dDeconvolve \
#-input ${study}.${subj}.${task}.motion_tlrc.py+tlrc \
#-polort $polort \
#-nfirst 0 \
...
#3dREMLfit \
#-input ${DATA_DIR}/func/${study}.${subj}.${task}.motion_tlrc.py+tlrc \
