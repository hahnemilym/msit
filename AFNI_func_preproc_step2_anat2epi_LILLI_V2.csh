...
3dresample \
-prefix ${study}.${subj}.${task}.motion.1x1x1 \
-input ${study}.${subj}.${task}.motion.rs+tlrc.BRIK \
-dxyz 1.0 1.0 1.0
...
#-epi_base 6 \
#-epi2anat \
#-tlrc_apar ${study}.${subj}.anat_MNI+tlrc \
#-suffix _py \
#-anat_has_skull no \
#-volreg off \
#-tshift off \
...
#3dfractionize \
#-template ${DATA_DIR}/func/${study}.${subj}.${task}.motion+tlrc \
#-input ${study}.${subj}.anat.seg.fsl+orig \
#-prefix ${study}.${subj}.anat.seg.fsl+orig.3x3x3 \
#-clip .2 -vote
...
#-polort $polort \
#./${study}.${subj}.${task}.motion+tlrc > ./NOISE_REGRESSOR.${task}.CSF.1D
...
#-polort $polort \
#./${study}.${subj}.${task}.motion+tlrc > ./NOISE_REGRESSOR.${task}.WM.1D
...
#3dDeconvolve \
#-input ${study}.${subj}.${task}.motion+tlrc \
#-polort $polort \
#-nfirst 0 \
...
#rm ${study}.${subj}.${task}.motion+orig*
#rm ${study}.${subj}.${task}.motion+tlrc*
