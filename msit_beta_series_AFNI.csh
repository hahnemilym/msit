...
## Why does input for 3dDeconvolve include 'scaled.resid_size' ?
## > was there another step after preproc ?
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
...
set stim_txt_file = msit_bsm_stim.csv # 193 stim times
set num_stimts = 1
...
1dtranspose ${DATA_DIR}/func/${study}.${SUBJECT}.func.censor.1D > ${DATA_DIR}/func/func_t
...
3dDeconvolve \
-force_TR $TR \
-input ${DATA_DIR}/func/${study}.${SUBJECT}.func.scaled.resid_size.nii
-nfirst 0 \
